![npm](https://img.shields.io/npm/v/@bennord-awesome-cordova-plugins/in-app-browser?label=npm%20-%20in-app-browser)

# Awesome Cordova Plugins (bennord fork)

Forked to investigate features in the following plugins:
